...
import com.yehorsk.medicalplatformbackend.notification.infra.notifications.model.PushNotificationSendResult
            ...
            Message.builder()
                ...
                .apply {
                    ...
                    when(recipient.platform) {
                        PlatformEntity.ANDROID -> {
                            setAndroidConfig(
                                AndroidConfig.builder()
                                    .setPriority(AndroidConfig.Priority.HIGH)
                                    .setCollapseKey(notification.conversationId.toString())
                                    .build()
                            )
                        }
                    }
